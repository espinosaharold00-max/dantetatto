    ...
    <div className="min-h-screen text-brand-pink">
      <div className="bg-brand-pink py-12">
        <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          <Image src="/images/logo-polylove.png" alt="PolyLove" width={350} height={350} className="mx-auto mb-6 rounded-full shadow-2xl object-cover ring-4 ring-brand-dark/10" />
